...
CREATE  TABLE IF NOT EXISTS `dvdstore`.`sous_commande` (
  ...
  PRIMARY KEY (`commande_id`, `fournisseur_id`) ,
...
-- -----------------------------------------------------
-- Table `dvdstore`.`sous_commande_has_dvd`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dvdstore`.`sous_commande_has_dvd` ;

CREATE  TABLE IF NOT EXISTS `dvdstore`.`sous_commande_has_dvd` (
  `sous_commande_commande_id` INT UNSIGNED NOT NULL ,
  `sous_commande_fournisseur_id` INT UNSIGNED NOT NULL ,
  `dvd_id` INT UNSIGNED NOT NULL ,
  `missingquantity` INT NOT NULL ,
  PRIMARY KEY (`sous_commande_commande_id`, `sous_commande_fournisseur_id`, `dvd_id`) ,
  INDEX `fk_sous_commande_has_dvd_dvd1_idx` (`dvd_id` ASC) ,
  INDEX `fk_sous_commande_has_dvd_sous_commande1_idx` (`sous_commande_commande_id` ASC, `sous_commande_fournisseur_id` ASC) ,
  CONSTRAINT `fk_sous_commande_has_dvd_sous_commande1`
    FOREIGN KEY (`sous_commande_commande_id` , `sous_commande_fournisseur_id` )
    REFERENCES `dvdstore`.`sous_commande` (`commande_id` , `fournisseur_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sous_commande_has_dvd_dvd1`
    FOREIGN KEY (`dvd_id` )
    REFERENCES `dvdstore`.`dvd` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
